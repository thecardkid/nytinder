			...
			React.createElement("div", {className: "container", style: this.props.style}, 
				...
				React.createElement("div", {className: "article-words", style: styleHeight}, 
					React.createElement("div", {className: "article-header"}, 
						React.createElement("h1", null, this.props.article['headline']['main'].replace('&amp;', '&'))
					), 
	...
	render: function() {
      ...
      return (
      	React.createElement(Motion, {key: i, style: style}, 
      		function (style) {
      			return React.createElement(Article, {article: root.state.articles[i], style: style, hovering: root.state.hover})
      		}
        )
      )
    });
